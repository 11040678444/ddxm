...
namespace  app\wxshop\alipay\service;
use app\wxshop\alipay\AopClient;
use app\wxshop\alipay\model\builder\AlipayTradeCancelContentBuilder;
use app\wxshop\alipay\model\builder\AlipayTradeQueryContentBuilder;
use app\wxshop\alipay\model\result\AlipayF2FPayResult;
use app\wxshop\alipay\model\result\AlipayF2FPrecreateResult;
use app\wxshop\alipay\model\result\AlipayF2FQueryResult;
use app\wxshop\alipay\model\result\AlipayF2FRefundResult;
use app\wxshop\alipay\model\request\AlipayTradeCancelRequest;
use app\wxshop\alipay\model\request\AlipayTradePayRequest;
use app\wxshop\alipay\model\request\AlipayTradePrecreateRequest;
use app\wxshop\alipay\model\request\AlipayTradeQueryRequest;
use app\wxshop\alipay\model\request\AlipayTradeRefundRequest;
use think\Exception;
