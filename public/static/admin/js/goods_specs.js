...
var step = {
    ...
    Creat_Table: function () {
        ...
        if (true) {
            ...
            console.log("长度："+zuheDate.length);
            ...
            // var td8 = $("<td ><input name=\"Txt_CountSon\" type=\"text\" maxlength=\"9\" required lay-verify=\"validateMoney\" class=\"layui-input\" autocomplete='off'  value='0.00'></td>");
            // td8.appendTo(tr);
 ...
 */
    function getSpescData(){
        ...
        $("#innerTable").find("tr").each(function(){
            ...
            var jianyilingshoujia = tdArr.eq(length+4).find('input').val();//原价
            var lingshoujia = tdArr.eq(length+5).find('input').val();//会员价
            ...
            // var yongjin = tdArr.eq(length+10).find('input').val();//初始销量
        ...
        form.on('radio(typeradio)', function (data) {
            if(data.value == 1){// 多规格
                ...
                html = '<div class="layui-form-item">\n' +
                    ...
                    '                    <div class="layui-input-inline">\n' +
                    '                        <input type="text" name="recommendprice" required lay-verify="required|validateMoney" maxlength="9" placeholder="请输入原价" value="0.00" autocomplete="off" class="layui-input">\n' +
                    '                    </div>\n' +
                    '                    <div class="layui-form-mid layui-word-aux">元</div>\n' +
                    '                </div>\n' +
                    '                <div class="layui-form-item">\n' +
