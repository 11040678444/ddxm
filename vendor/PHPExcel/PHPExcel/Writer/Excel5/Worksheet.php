...
//            if ($row + 1 > 65536 or $column + 1 > 256) {
    ...
    private function writeCFRule(PHPExcel_Style_Conditional $conditional)
    {
        ...
        if ($bFormatBorder == 1) {
            ...
            //@todo writeCFRule() => $blockLineStyle => Customer Color for left line
            //@todo writeCFRule() => $blockLineStyle => Customer Color for right line
            ...
            $blockColor = 0;
            //@todo writeCFRule() => $blockColor => Customer Color for top line
            //@todo writeCFRule() => $blockColor => Customer Color for bottom line
            //@todo writeCFRule() => $blockColor => Customer Color for diagonal line
