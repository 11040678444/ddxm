...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
	...
	/**
	 * Customer of first used row (at least 0)
	 * @var int
	 */
	private $_firstRowIndex;

	/**
	 * Customer of last used row. (no used rows means -1)
	 * @var int
	 */
	private $_lastRowIndex;

	/**
	 * Customer of first used column (at least 0)
	 * @var int
	 */
	private $_firstColumnIndex;

	/**
	 * Customer of last used column (no used columns means -1)
	 * @var int
	 */
...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	 ...
	 * @param int $xfIndex Customer to XF record
	 */
	 ...
	 * @param array $arrcRun Customer to Font record and characters beginning
	 */
	...
	private function _writeCFRule(PHPExcel_Style_Conditional $conditional){
		...
		if($bFormatBorder == 1){
			...
			//@todo _writeCFRule() => $blockLineStyle => Customer Color for left line
			//@todo _writeCFRule() => $blockLineStyle => Customer Color for right line
			...
			$blockColor = 0;
			//@todo _writeCFRule() => $blockColor => Customer Color for top line
			//@todo _writeCFRule() => $blockColor => Customer Color for bottom line
			//@todo _writeCFRule() => $blockColor => Customer Color for diagonal line
