...
class PHPExcel_Writer_Excel5_Xf
{
	...
	/**
	 * Customer to the FONT record. Customer 4 does not exist
	 * @var integer
	 */
	private $_fontIndex;
	...
	*/
	...
	function writeXf()
	{
		...
		$ifnt           = $this->_fontIndex;   // Customer to FONT record
		$ifmt           = $this->_numberFormatIndex;  // Customer to FORMAT record
	 ...
	 *
	 * @access public
	 * @param integer $numberFormatIndex Customer to format record
	 */
