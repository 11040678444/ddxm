<?php /*a:2:{s:66:"D:\PHPTutorial\WWW\ddxm_svn\application\admin\view\main\index.html";i:1601275829;s:68:"D:\PHPTutorial\WWW\ddxm_svn\application\admin\view\index_layout.html";i:1601275830;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="layui-col-lg6 layui-col-md12">
                ...
                <table class="layui-table magt0">
                    ...
                    <tbody>
                        <tr>
                            <td>当前版本</td>
                            <td class="version">ddxm v<?php echo htmlentities(app('config')->get('version.ddxm_version')); ?></td>
                        </tr>
                        <tr>
                            <td>PHP 版本</td>
...
function getLangDate() {
    ...
    // document.getElementById("nowTime").innerHTML = "亲爱的<?php echo htmlentities($userInfo['username']); ?>，" + timeValue + "好！ 欢迎使用熊猫 v<?php echo htmlentities(app('config')->get('version.ddxm_version')); ?>,当前时间为： " + newDate + "　" + week;
    document.getElementById("nowTime").innerHTML = "亲爱的<?php echo htmlentities($userInfo['username']); ?>，" + timeValue + "好！ 欢迎使用捣蛋熊猫-后台管理系统,当前时间为： " + newDate + "　" + week;
