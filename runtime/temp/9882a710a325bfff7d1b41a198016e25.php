<?php /*a:2:{s:66:"D:\PHPTutorial\WWW\ddxm_svn\application\admin\view\menu\index.html";i:1601275828;s:68:"D:\PHPTutorial\WWW\ddxm_svn\application\admin\view\index_layout.html";i:1601275830;}*/ ?>
<!DOCTYPE html>
<html>
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    ...
    <a class="layui-btn layui-btn-sm"  id="AddMenu">新增后台菜单</a>
  </div>
</script>
...
layui.use('table', function() {
    ...
    $("#AddMenu").on("click",function(){
        var url  ="<?php echo url('admin/menu/add'); ?>";
        layer.open({
            type: 2,
            title: '在线调试',
            area: ['600px', '640px'],
