<?php /*a:2:{s:67:"D:\PHPTutorial\WWW\ddxm_svn\application\admin\view\index\index.html";i:1601275828;s:62:"D:\PHPTutorial\WWW\ddxm_svn\application\admin\view\layout.html";i:1601275827;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link rel="stylesheet" href="/public/static/admin/css/global.css">
...
<body class="layui-layout-body">
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            <a href="#" class="logo">捣蛋熊-后台管理</a>
            <a href="javascript:;" class="hideMenu icon iconfont iconshangpinliebiaotubiao01"></a>
            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item"><a href="<?php echo url('/index.php/Index/Index/index'); ?>" target="_blank"><i class="iconfont icon-homepage"></i>&nbsp;站点首页</a></li>
                ...
                <li class="layui-nav-item"><a href="javascript:;"><img src="/public/static/admin/img/avatar.png" class="layui-nav-img userAvatar" width="35" height="35"><?php echo htmlentities($userInfo['username']); ?></a>
                    <dl class="layui-nav-child">
        ...
        <div class="layui-body" id="B_frame">
            <div class="layui-tab mag0" id="top_tabs_box" lay-filter="Tab">
                <div class="tab-go-refresh" id="J_refresh"><i class="iconfont icon-shuaxin"></i></div>
        ...
        <div class="layui-footer">
            ©测试 v<?php echo htmlentities(app('config')->get('version.ddxm_version')); ?>
        </div>
    </div>
                ...
                for (var attr in data) {
                    if (data[attr] && typeof(data[attr]) === 'object') {
                        ...
                        if (attr === 'title') {
                            ...
                            if (!(data['isChild'])) {
                                //一级菜单  layui-nav-item  layui-nav-itemed 默认展开下拉菜单 layui-nav-item不展开
                                html.push('<li class="layui-nav-item "><a href="' + data.url + '" lay-id="' + data.id + '"><i class="iconfont ' + data.icon + '"></i>&nbsp;<b>' + data.title + '</b></a>');
                            } else {
                                //二级菜单
